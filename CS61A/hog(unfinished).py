...
def roll_dice(num_rolls, dice=six_sided):
    ...
    numbers=[]
    oneornot=False
    for value in range(0,num_rolls):
        num=dice()
        if num==1:
            oneornot=True
        numbers.append(num)
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    tsum=0
    if num_rolls==0:
        tsum=free_bacon(opponent_score)
    else:
        tsum=roll_dice(num_rolls,dice)
    return tsum
    # END PROBLEM 3
...
def swine_align(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4a
    lower=min(player_score, opponent_score)
    if lower==0:
        return False
    GCD=0
    for value in range(1,lower+1):
        if player_score%value==0 and opponent_score%value==0:
            GCD=value
    if GCD>=10:
        return True
    else:
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0<goal and score1<goal:
        if who==0:
            ...
            scores = take_turn(num_rolls, score1, dice)
            score0 = score0 + scores
            if score0>=goal:
                break
        ...
        if who ==1:
            ...
            scores = take_turn(num_rolls, score0, dice)
            score1 = score1 + scores
